...
const Conversation = ({conversation, isOnline}) => {
  ...
  const user = conversation.participants[0];    //this is the user we are chating with
  ...
  return (
    <Flex
      ...
      bg={selectedConversation?._id === conversation._id ? (colorMode == "ligth"? "gray.400" : "gray.dark" )
       : "" }
      borderRadius={"md"}
    >
        <WrapItem>
